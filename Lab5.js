const Lab5 = (app) => {
    ...
    app.get("/a5/add/:a/:b", (req, res) => {
      ...
      app.get("/a5/assignment/title/:newTitle", (req, res) => {
          ...
          app.get("/a5/assignment/moduleCompletion/:completed", (req, res) => {
        ...
        app.get("/a5/todos/:id/delete", (req, res) => {
          ...
          res.json(todos);
            ...
            app.get("/a5/todos/update/description/:id/:description", (req, res) => {
              const { id, description } = req.params;
              const todo = todos.find((t) => t.id === parseInt(id));
              todo.description = description;
              res.json(todos);
            });
            app.get("/a5/todos/update/completed/:id/:completed", (req, res) => {
